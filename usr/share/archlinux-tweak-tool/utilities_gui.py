...
repositories</b>"
    ...
    lbl_arco_repo.set_hexpand(True)
    lbl_arco_repo.set_vexpand(True)
    hbox5.append(lbl_arco_repo)
    ...
    vboxstack9.append(hbox3)
    vboxstack9.append(hbox4)
    # vboxstack9.pack_start(hbox5, False, False, 0)
    vboxstack9.append(vbox14)
